...
const Card = () => {
  ...
  return (
    <div className="shrink-0 grow">
      <div className="absolute overflow-hidden flex ml-15">
        <img
          className="rounded-[15px] w-[273px] h-[182px]"
          src={`images/${Chains.image}`} // Using template literals for concatenation
          alt={Chains.alt || "Image"} // Fallback alt text
        />
      </div>
    </div>
  );
...

{
  /*
    <div className=" shrink-0 grow">
      ...
      <img  className ="rounded-[15px] w-[273px] h-[182px] " src="images/" + {Chains.image} alt="" />
